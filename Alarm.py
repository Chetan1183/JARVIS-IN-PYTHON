...
extracted_time = open('E:\\PYTHON PROJECTS\\JARVIS 2.0\\data.txt','rt')
time = extracted_time.read()
Time = str(time)

delete_time = open('E:\\PYTHON PROJECTS\\JARVIS 2.0\\data.txt','r+')
...
def RingerNow(time):
    ...
    time_now = time_to_set.replace("eva","")
    ...
    while True:
        ...
        if current_time == Alarm_Time:
            print("wake up sir, it's time to wakeup.")
            playsound("E:\\PYTHON PROJECTS\\JARVIS 2.0\\Avengers.mp3")
